...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        video = upload.video(
            ...
            name=title or 'Historia de las mujeres antiguas',
...
def main():
    ...
    description = sys.argv[2] if len(sys.argv) > 2 else "Historia de las mujeres antiguas! 🏛️"
    title = sys.argv[3] if len(sys.argv) > 3 else "Historia de las mujeres antiguas"
